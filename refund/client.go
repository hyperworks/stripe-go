...
func (c Client) New(params *stripe.RefundParams) (*stripe.Refund, error) {
	...
	err := c.B.Call("POST", fmt.Sprintf("/beta_refunds"), c.Key, body, &params.Params, refund)
...
func (c Client) Get(id string, params *stripe.RefundParams) (*stripe.Refund, error) {
	...
	refund := &stripe.Refund{}
	err := c.B.Call("GET", fmt.Sprintf("/beta_refunds/%v", id), c.Key, body, &params.Params, refund)
...
func (c Client) Update(id string, params *stripe.RefundParams) (*stripe.Refund, error) {
	...
	refund := &stripe.Refund{}
	err := c.B.Call("POST", fmt.Sprintf("/beta_refunds/%v", id), c.Key, body, &params.Params, refund)
...
func (c Client) List(params *stripe.RefundListParams) *Iter {
	...
	return &Iter{stripe.GetIter(lp, body, func(b url.Values) ([]interface{}, stripe.ListMeta, error) {
		...
		err := c.B.Call("GET", fmt.Sprintf("/beta_refunds"), c.Key, &b, nil, list)
